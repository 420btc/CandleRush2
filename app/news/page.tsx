  ...
  if (!newsItems || newsItems.length === 0) {
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <p className="text-center text-xl text-gray-600">No se pudieron cargar las noticias en este momento. Inténtalo más tarde.</p>
      </div>
    );
  }
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {newsItems.map((item, index) => (
                <Card key={item.link || index} className="flex flex-col bg-yellow-400 text-black">
                  ...
                  <CardContent className="bg-yellow-400 text-black p-2 h-24 overflow-hidden">
                    <p className="text-sm text-black font-bold line-clamp-3">
